...
/**
 * Array of options we use in theworldin35mm.
 * 
 * This is an array containing all the names and default values that we use for
 * theworldin35mm. Each element is also an array with three possible keys
 * 
...
/**
 * Filter function to create the option page for theworldin35mm.
 */
function theworldin35mm_add_pages() {
	add_theme_page('theworldin35mm Options', 'theworldin35mm', 'edit_themes', basename(__FILE__), 'theworldin35mm_admin');
}
 ...
 */
function theworldin35mm_admin() {
	global $updateflag;
?>
	
	<div class="wrap">
	<h2> <?php echo __('theworldin35mm Options')?> </h2>
	<?php if ($updateflag) { ?><div class="updated"><p><strong><?php _e('Options saved.') ?></strong></p></div> <?php } ?>
	...
	<p class="submit">
		<input type="submit" name="Submit" value="<?php _e('Update Options', 'theworldin35mm' ); ?>" />
	</p>
</form>
<?php
}
...
if (is_admin()) {
	...
	add_action('admin_menu', 'theworldin35mm_add_pages');
}
?>